...
(crops_plot <- 
  ...
  summarise(Value=sum(Value)) %>% 
    ...
    annotate("text", x=0.35, y=0.9, label="Crop production")+
...
(livestock <- 
    ...
    labs(y=bquote(Biomass~(million~tonnes)))+
    scale_y_continuous(labels = c("0", "3","6","9", "12"), breaks = c(0, 3e+6,6e+6,9e+6, 12e+6), limits = c(0,12e+6))+
    scale_x_continuous(breaks=c(1960,1980,2000,2020), labels = c("1960","1980","2000","2020"), limits = c(1960,2020))+
...
(seafood <- 
   ...
   scale_y_continuous(labels = c("0", "50","100","150", "200", "250"), breaks = c(0, 5e+4,10e+4,15e+4, 20e+4, 25e+4), limits = c(0,26e+4))+
   scale_x_continuous(breaks=c(1960,1980,2000,2020), labels = c("1960","1980","2000","2020"), limits = c(1960,2020))+
